...
func generate(f *parse.FileSet, mode gen.Method) (*bytes.Buffer, *bytes.Buffer, error) {
	...
	myImports := []string{"github.com/desertbit/msgp/msgp"}
	...
	if mode&gen.Test == gen.Test {
		...
		if mode&(gen.Encode|gen.Decode) != 0 {
			writeImportHeader(testbuf, "bytes", "github.com/desertbit/msgp/msgp", "testing")
		} else {
			writeImportHeader(testbuf, "github.com/desertbit/msgp/msgp", "testing")
		}
		testwr = testbuf
	}
...
func writePkgHeader(b *bytes.Buffer, name string) {
	...
	// https://github.com/desertbit/msgp/issues/229
	// https://golang.org/s/generatedcode
	b.WriteString("// Code generated by github.com/desertbit/msgp DO NOT EDIT.\n\n")
}
