...
You can [read more about the code generation options here](http://github.com/desertbit/msgp/wiki/Using-the-Code-Generator).
...
### Features
 ...
 - [Preprocessor directives](http://github.com/desertbit/msgp/wiki/Preprocessor-Directives)
...
the data "type" (`int8`) and the raw binary. You [can see a worked example in the wiki.](http://github.com/desertbit/msgp/wiki/Using-Extensions)
...
You can read more about how `msgp` maps MessagePack types onto Go types [in the wiki](http://github.com/desertbit/msgp/wiki).
